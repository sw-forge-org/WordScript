 ...
 * Source: apps/www/registry/elevenlabs-ui/hooks/use-transcript-viewer.ts @ 6e5b681c01ee */
"use client"
...
/* WORDSCRIPT. Upstream imports this shape as a type from
   `@elevenlabs/elevenlabs-js`, which would pull the whole ElevenLabs API client
   in for three arrays. It is declared here instead, so a transcript timed by
   the native runtime satisfies it without the product depending on a speech
   vendor's SDK to describe its own timings. */
