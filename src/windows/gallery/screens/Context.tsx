...
function ContextScreenBody({ panel }: { panel: "ask" | "actions" }) {
  ...
  return (
    <>
      <ViewTop
        ...
        banner={<PreviewBanner>Planned for V2. Nothing on the Summary tab is wired.</PreviewBanner>}
      />
      <Pane
        list={
          <>
...
export function ContextScreen() {
  return <ContextScreenBody panel="ask" />;
}
