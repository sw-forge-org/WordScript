...
- Current state: Spec created 2026-07-24; last drift check 2026-07-25 (capture
  shortcut lane rebuild merged: `core::shortcut` as contract owner, the capability
  matrix, and the grab-versus-observe delivery split).
