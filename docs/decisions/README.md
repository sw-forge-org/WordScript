...
- [0237](0237-the-transcripts-are-their-own-collection-so-the-index-retention-stops-taking-them-and-the-archive-gets-a-reading-and-a-door.md):
  The transcripts are their own collection, so the index retention stops taking them, and the archive gets a reading and a door.
